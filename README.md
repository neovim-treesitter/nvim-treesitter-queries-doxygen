# nvim-treesitter-queries-doxygen

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-doxygen/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-doxygen/actions/workflows/validate.yml)

Neovim tree-sitter queries for **doxygen**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-doxygen",
...
- [ ] Changes are scoped to `doxygen` — do not include files for other languages
